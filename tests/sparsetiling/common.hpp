...
static int mesh_mpi1_c_set[][2] = {{9, 6},  // (local size, halo size)
                                   {9, 6}};
static int mesh_mpi1_c2v[][60] = {{0,1,4,5 , 1,2,5,6 , 2,3,6,7 , 4,5,8,9 , 5,6,9,10,
                                   6,7,10,11 , 8,9,12,13 , 9,10,13,14 , 10,11,14,15,
                                   3,16,7,18 , 16,17,18,19 , 7,18,11,20 , 18,19,20,21,
                                   11,20,15,22 , 20,21,22,23},
                                  {14,0,17,3 , 0,1,3,4 , 1,2,4,5 , 17,3,20,6,
                                   3,4,6,7 , 4,5,7,8 , 20,6,23,9 , 6,7,9,10,
                                   7,8,10,11 , 12,13,15,16 , 13,14,16,17, 15,16,18,19,
                                   16,17,19,20 , 18,19,21,22 , 19,20,22,23}};
static double mesh_mpi1_coords[][60] = {{0,0 , 0,1 , 0,2 , 0,3 , 1,0 , 1,1 , 1,2 , 1,3,
                                         2,0 , 2,1 , 2,2 , 2,3 , 3,0 , 3,1 , 3,2 , 3,3,
                                         0,4 , 0,5 , 1,4 , 1,5 , 2,4 , 2,5 , 3,4 , 3,5},
                                        {0,4 , 0,5 , 0,6 , 1,4 , 1,5 , 1,6 , 2,4 , 2,5,
                                         2,6 , 3,4 , 3,5 , 3,6 , 0,1 , 0,2 , 0,3 , 1,1,
